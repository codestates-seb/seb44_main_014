...
VALUES
 ...
 -- 테이블명: question (5)
INSERT INTO question (member_id,category,title,content,image,location,status,created_at,modified_at,view_count,comment_count)
VALUES
 ...
 -- 테이블명: comment (5)
INSERT INTO comment (member_id,question_id,content,created_at,modified_at)
VALUES
 ...
 -- 테이블명: mate (5)
INSERT INTO mate (question_id,mate_num)
VALUES
    (1,1),
    (2,1),
    (3,2),
